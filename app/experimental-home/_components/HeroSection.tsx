...
export default function HeroSection({ categories, featuredItems, title, subtitle, titleHighlight, description, heroCTALink, styles, sectionId, background, hiddenFields }: HeroSectionProps) {
