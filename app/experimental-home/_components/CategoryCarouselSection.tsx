...
function CategoryCard({ tile }: { tile: CollectionTile }) {
    return (
        <Link
            href={tile.href}
            className="group relative aspect-[4/5] block overflow-hidden rounded-[2.5rem] bg-muted shadow-xl"
            data-no-edit="true"
        >
            <img
            ...
            <div className="absolute inset-0 p-8 flex flex-col justify-end transform transition-transform duration-500 group-hover:-translate-y-2">
                <div className="flex items-end justify-between">
                    ...
                    <div className="size-10 rounded-2xl bg-white/20 backdrop-blur-md flex items-center justify-center text-white border border-white/20 transform rotate-45 group-hover:rotate-0 transition-transform duration-500">
